import {getUserList,searchByKey,updateUser,deleteUser,getRoleList,addUserRole} from '../../services/Cms/userManage';
	...
	effects:{
	    ...
	    *userRole({payload},{call,put}){
	    	...
	    	if(data){
	    	  ...
	    	  yield put({type:'querySuccess',payload:{roleList:roleList,checkedList:checkedList,userRoleVisible:true}})
	    	}
	    },
	    *addUserRole({payload},{call,put}){
	    	...
	    	if(data){
	    		...
	    		yield put({type:'querySuccess',payload:{userRoleVisible:false}})
	    	}
	    }
	},
